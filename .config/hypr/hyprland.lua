...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd(pwdManager))
...
hl.bind(meh .. " + T", hl.dsp.window.float({ action = "toggle" }))
hl.bind(meh .. " + F", hl.dsp.window.fullscreen({ action = "toggle" }))
...
hl.bind(secondMod .. " + s", hl.dsp.window.move({ workspace = 1 }))
hl.bind(secondMod .. " + d", hl.dsp.window.move({ workspace = 2 }))
hl.bind(secondMod .. " + f", hl.dsp.window.move({ workspace = 3 }))
hl.bind(secondMod .. " + g", hl.dsp.window.move({ workspace = 4 }))
